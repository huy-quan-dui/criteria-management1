...
public class Expense extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        adapter.addDataForChi(LoadDataFromDB(null,null,null));
    }
    ...
    public void ConnectView()
    {
        ...
        listView=(ListView) findViewById(R.id.idListViewChiTieu);
    }
       ...
       imgbtn_reciept.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Expense.this, Reciept.class);
                intent.putExtra("previous_activity","com.example.quan_ly_chi_tieu.activities.Expense");
        ...
        editTextMonth.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                adapter.addDataForChi(LoadDataFromDB(getNgayThangNam()[0],getNgayThangNam()[1],getNgayThangNam()[2]));
            }
    ...
    public List<BanGhiChi> LoadDataFromDB(@Nullable String ngay,@Nullable String thang, @Nullable String nam)
    {
        List<BanGhiChi> list= new ArrayList<>();
        String ngayTemp="";
        String thangTemp="";
        String namTemp="";
        ...
        String ngayThangNam=ngayTemp+thangTemp+namTemp+"%";
            ...
            if(cursorMoney!=null && cursorMoney.moveToLast())
            {
                ...
                txtViewTotalMoney.setText("Chi tiêu: -"+cursorMoney.getFloat(0)+" VND");
            ...
            while(cursor.moveToNext())
            {
                ...
                BanGhiChi banGhiChi= new BanGhiChi(Stt,Ngay,ID,Money,Note);
    ...
    {
        adapter=new CustomListBanGhiChi(R.layout.mot_dong_listview,this,LoadDataFromDB(ngay,thang,nam));

        listView.setAdapter(adapter);
        adapter.SetDataSetChangedListener(new CustomListBanGhiChi.OnDataSetChangedListener() {
            @Override
            public void onDataSetChanged() {
                txtViewTotalMoney.setText("Chi tiêu: -"+LoadMoneyFromChi(getNgayThangNam()[0],getNgayThangNam()[1],getNgayThangNam()[2])+" VND");
            }
        });
